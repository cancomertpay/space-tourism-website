  ...
  return (
    <Section overflow={"hidden"} background={"home"}>
      ...
      <div className="lg:hidden">
        ...
        <ContentContainer>
          <HomeHeader>
            <h1 className="flex flex-col gap-5 items-center justify-center mb-5 uppercase tracking-widest pt-8">
          ...
          <HomeMain>
            <p className="px-10 md:px-16 md:mx-32 md:leading-relaxed md:text-lg tracking-wide text-pale-blue">
